...
def read_file_list(list_file, sets, use_color, color_channel=(), remove_zero_label=True, search_tree_postfix='.pickle'):
    ...
    search_tree_file_list = [splitext(f)[0] + search_tree_postfix for f in data_file_list]

    reader_list = []
    for data_f, label_ps, prefix, tree_f in zip(data_file_list, label_file_list, prefixes, search_tree_file_list):
...
class FileDataReader:
    def __init__(
        ...
        self.search_tree_path = search_tree_path
